...
Used for implicit conversions like float to int,char to int,etc
...
Inheritance+virtual concept is mandatory for acheiving dynamic_cast
...
#if 0 //Used for converting void* to int*
